        ...
        if (
          ...
          if (roomsInfo.rooms.open[room_name].leaderBoard) {
            ...
            if (
              ...
              io.to(leaderB[leaderB.length - 2][2]).emit(
                "chat announce taxs",
                "language.taxs",
                "red",
                `${firstOne[0]}`,
            ...
            if (
              ...
              for (const player in obj) {
                if (
                  ...
                  leaderBoard.push([0, obj[player].nickname, player, 0]); // ADDED 0
                } else {
                  leaderBoard.push([
                    obj[player].points,
                    obj[player].nickname,
              ...
              leaderBoard.sort((a, b) => b[3] - a[3]); // For descending sort
